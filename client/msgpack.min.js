   ...
   return (function t(r, e, n) {
      function i(f, u) {
         if (!e[f]) {
            if (!r[f]) {
               ...
               if (!u && a) return a(f, !0);
               if (o) return o(f, !0);
               const s = new Error("Cannot find module '" + f + "'");
   ...
   })(
      {
         1: [
            ...
            { './codec': 10, './decode': 12, './decoder': 13, './encode': 15, './encoder': 16, './ext': 20 },
         ],
         2: [
            function (t, r, e) {
               (function (Buffer) {
         ...
         3: [
            function (t, r, e) {
                  ...
                  for (var e = this, n = r || (r |= 0), i = t.length, o = 0, f = 0; f < i; )
                     (o = t.charCodeAt(f++)),
                        o < 128
                           ...
                           : ((o = (((o - 55296) << 10) | (t.charCodeAt(f++) - 56320)) + 65536),
                             (e[n++] = 240 | (o >>> 18)),
                             (e[n++] = 128 | ((o >>> 12) & 63)),
                             (e[n++] = 128 | ((o >>> 6) & 63)),
                             (e[n++] = 128 | (63 & o)));
                     ...
                     (f = n[i++]),
                        f < 128
                           ...
                           : (192 === (224 & f)
                                ? (f = ((31 & f) << 6) | (63 & n[i++]))
                                : 224 === (240 & f)
                                ? (f = ((15 & f) << 12) | ((63 & n[i++]) << 6) | (63 & n[i++]))
                                : 240 === (248 & f) &&
                                  (f = ((7 & f) << 18) | ((63 & n[i++]) << 12) | ((63 & n[i++]) << 6) | (63 & n[i++])),
                             f >= 65536
                                ? ((f -= 65536), (o += String.fromCharCode((f >>> 10) + 55296, (1023 & f) + 56320)))
                                : (o += String.fromCharCode(f)));
                  return o;
               }
               ...
               function o(t, r, e, n) {
                  ...
                  const o = n - e;
                  if (t === this && e < r && r < n) for (i = o - 1; i >= 0; i--) t[i + r] = this[i + e];
         ...
         9: [
            function (t, r, e) {
               ...
               function i(t) {
                  for (const r in t) n.prototype[r] = o(n.prototype[r], t[r]);
               }
            ...
            function (t, r, e) {
               function n(t) {
                  ...
                  if (t && ((this.options = t), t.codec)) {
                     const r = (this.codec = t.codec);
                     r.bufferish && (this.bufferish = r.bufferish);
                  }
               }
               e.DecodeBuffer = n;
               const i = t('./read-core').preset,
         ...
         21: [
            function (t, r, e) {
               ...
               function o() {
                  function t(t) {
                     const r = this.offset ? p.prototype.slice.call(this.buffer, this.offset) : this.buffer;
               ...
               function f() {
                  function t() {
                     const t = this.start;
                     if (t < this.offset) {
                        const r = (this.start = this.offset);
                  ...
                  function e() {
                     const t = this.buffers || (this.buffers = []),
               ...
               function s() {
                  const t = this.buffers && this.buffers.length;
                  return t ? (this.flush(), this.pull()) : this.fetch();
               }

               function c(t) {
                  const r = this.buffers || (this.buffers = []);
                  r.push(t);
               }
         ...
         22: [
            function (t, r, e) {
               ...
               function o(t, r) {
                  const e = this.extUnpackers || (this.extUnpackers = []);
                  e[t] = h.filter(r);
               }
            ...
            { './codec-base': 9, './ext-buffer': 17, './ext-unpacker': 19, './read-format': 23, './read-token': 24 },
         ],
         23: [
            function (t, r, e) {
               function n(t) {
                  const r = k.hasArrayBuffer && t && t.binarraybuffer,
                     e = t && t.int64,
                     n = T && t && t.usemap,
                     B = {
                        map: n ? o : i,
               ...
               function c(t, r) {
                  ...
                  const f = _.slice.call(t.buffer, e, i);
                  return o(f);
               }
         ...
         24: [
            function (t, r, e) {
               ...
               function o(t) {
                  let r,
                     e = i(t).slice();
                  for (e[217] = e[196], e[218] = e[197], e[219] = e[198], r = 160; r <= 191; r++)
                     e[r] = a(r - 160, t.bin);
                  return e;
               }
         ...
         25: [
            function (t, r, e) {
               ...
               function o(t, r, e) {
                  ...
                  const i = r.name;
                  if (i && 'Object' !== i) {
                     const o = this.extPackers || (this.extPackers = {});
                     o[i] = n;
                  } else {
                     const f = this.extEncoderList || (this.extEncoderList = []);
                     f.unshift([r, n]);
                  }
               }

               function f(t) {
                  const r = this.extPackers || (this.extPackers = {}),
                     e = t.constructor,
                     n = e && e.name && r[e.name];
                  if (n) return n;
                  for (let i = this.extEncoderList || (this.extEncoderList = []), o = i.length, f = 0; f < o; f++) {
                     const u = i[f];
                     if (e === u[0]) return u[1];
                  }
               }
               ...
               function n(t) {
                  ...
                  function b(t) {
                     function r(r, e) {
                        ...
                        const l = 1 === a ? 160 + n : a <= 3 ? 215 + a : 219;
                        _[l](r, n), (r.offset += n);
                     }
                     return r;
                  }
                  ...
                  function w(t, r) {
                     ...
                     const e = t.codec.getExtPacker(r);
                  ...
                  function m(t, r) {
                     ...
                     _[n](t, e);
                     for (let i = t.codec.encode, o = 0; o < e; o++) i(t, r[o]);
                  }
         ...
         28: [
            function (t, r, e) {
               ...
               for (let i = (e.uint8 = new Array(256)), o = 0; o <= 255; o++) i[o] = n(o);
            },
            {},
         ],
         29: [
            function (t, r, e) {
               (function (r) {
                  ...
                  function c(t, r, e) {
                     if ((('string' == typeof e && '' !== e) || (e = 'utf8'), !Buffer.isEncoding(e)))
                  ...
                  function h(t, r) {
                     const e = r.length < 0 ? 0 : 0 | d(r.length);
                     t = o(t, e);
                  ...
                  function l(t, r, e, n) {
                     ...
                     return (
                        ...
                        Buffer.TYPED_ARRAY_SUPPORT ? ((t = r), (t.__proto__ = Buffer.prototype)) : (t = h(t, r)),
                        t
                     );
                  }
                  ...
                  function A(t, r, e, n) {
                     ...
                     n > o / 2 && (n = o / 2);
                     for (var f = 0; f < n; ++f) {
                        const u = parseInt(r.substr(2 * f, 2), 16);
                        if (isNaN(u)) return f;
                        t[e + f] = u;
                     }
                     return f;
                     ...
                     for (var n = [], i = r; i < e; ) {
                        ...
                        if (i + u <= e) {
                           ...
                           switch (u) {
                              ...
                              case 2:
                                 (a = t[i + 1]),
                                    128 === (192 & a) && ((h = ((31 & o) << 6) | (63 & a)), h > 127 && (f = h));
                                 break;
                              case 3:
                                 (a = t[i + 1]),
                                    (s = t[i + 2]),
                  ...
                  function N(t, r, e, n, i) {
                     return (
                        i || M(t, r, e, 4, 3.4028234663852886e38, -3.4028234663852886e38),
                  ...
                  function F(t, r, e, n, i) {
                     return (
                        i || M(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308),
                  ...
                  (e.Buffer = Buffer),
                     ...
                     (Buffer.prototype.swap32 = function () {
                        ...
                        for (let r = 0; r < t; r += 4) b(this, r, r + 3), b(this, r + 1, r + 2);
                        return this;
                     }),
                     ...
                     (Buffer.prototype.compare = function (t, r, e, n, i) {
                        ...
                        for (
                           var o = i - n, f = e - r, u = Math.min(o, f), a = this.slice(n, i), s = t.slice(r, e), c = 0;
                           c < u;
                           ++c
                        )
                           if (a[c] !== s[c]) {
                     ...
                     (Buffer.prototype.write = function (t, r, e, n) {
                        if (void 0 === r) (n = 'utf8'), (e = this.length), (r = 0);
                           ...
                           (r = 0 | r),
                              isFinite(e) ? ((e = 0 | e), void 0 === n && (n = 'utf8')) : ((n = e), (e = void 0));
                        }
                  ...
                  (Buffer.prototype.slice = function (t, r) {
                     ...
                     (Buffer.prototype.copy = function (t, r, e, n) {
                        ...
                        else if (o < 1e3 || !Buffer.TYPED_ARRAY_SUPPORT) for (i = 0; i < o; ++i) t[i + r] = this[i + e];
                     ...
                     (Buffer.prototype.fill = function (t, r, e, n) {
                        ...
                        if ('number' == typeof t) for (o = r; o < e; ++o) this[o] = t;
                           ...
                           const f = Buffer.isBuffer(t) ? t : q(new Buffer(t, n).toString()),
                              u = f.length;
         ...
         30: [
            function (t, r, e) {
               ...
               function o(t) {
                  ...
                  return (
                     2 === f
                        ? ((o = (c[t.charCodeAt(r)] << 2) | (c[t.charCodeAt(r + 1)] >> 4)), (u[s++] = 255 & o))
                        : 1 === f &&
                          ((o =
                             (c[t.charCodeAt(r)] << 10) |
                           ...
                           isNaN(r) || r === 1 / 0
                              ...
                              : ((f = Math.floor(Math.log(r) / Math.LN2)),
                                ...
                                f + h >= c
                                   ...
                                   : ((u = r * Math.pow(2, h - 1) * Math.pow(2, i)), (f = 0)));
                        i >= 8;
                  ...
                  !(function (e) {
                     function o(t, r, n) {
                        ...
                        function v(t, r, e, n, i) {
                           if (
                              (E && A && (r instanceof A && (r = new E(r)), n instanceof A && (n = new E(n))),
                              !(r || e || n || g))
                           )
                     ...
                     function l(t, r, e) {
                        for (let n = r + 8; n > r; ) (t[--n] = 255 & e), (e /= 256);
                     }
                     ...
                     function d(t, r, e) {
                        for (let n = r + 8; r < n; ) (t[r++] = 255 & e), (e /= 256);
                     }
